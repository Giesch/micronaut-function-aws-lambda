...
You should also ensure that your version of micronaut-function-aws is at least 1.3.5:

[source, groovy]
implementation "io.micronaut:micronaut-function-aws:1.3.5"
...
Be sure to update the CodeUri field to your local build path if necessary.
